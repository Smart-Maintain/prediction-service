...
for fd in files:
    ...
    # Load Train and Test
    train_path = DATA_RAW_DIR / f'train_{fd}.txt'
    test_path = DATA_RAW_DIR / f'test_{fd}.txt'
    ...
    train_df.to_csv(DATA_PROCESSED_DIR / f'train_{fd}_preprocessed.csv', index=False)
    test_df.to_csv(DATA_PROCESSED_DIR / f'test_{fd}_preprocessed.csv', index=False)
